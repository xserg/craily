        ...
        <form role="form"  method="post" class="form-horizontal form-groups-bordered validate" novalidate="novalidate" enctype="multipart/form-data">
            ...
            <div class="form-group">
                        ...
                        <div class="panel-body">
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-new thumbnail" style="max-width: 310px; height: 110px;" data-trigger="fileinput">
                                    <img src="<?= !empty($row['login_image']) ? get_site_image_src("images/", $row['login_image']) : 'http://placehold.it/3000x1000' ?>" alt="--">
                                </div>
                                ...
                                <div>
                                    <span class="btn btn-white btn-file">
                                        ...
                                        <input type="file" name="login_image" accept="image/*" <?php if(empty($row['login_image'])){echo 'required=""';}?>>
                                    </span>
                ...
                <div class="col-md-7">
                    ...
                    <input type="text" name="login_heading" value="<?= $row['login_heading'] ?>" class="form-control" autofocus required>
                </div>
            </div>
            <div class="form-group">
