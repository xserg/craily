 ...
 */
(function($){$.fn.timepicki1=function(options){var defaults={format_output:function(tim,mini,meri){if(settings.show_meridian){tim=Math.min(Math.max(parseInt(tim),1),12);if(tim<10)
...
function open_timepicki(){set_date(settings.start_time);ele_next.fadeIn();var first_input=ele_next.find('input:visible').first();first_input.focus();var first_input_exit_handler=function(e){if(e.which===9&&e.shiftKey){first_input.off('keydown',first_input_exit_handler);var all_form_elements=$(':input:visible:not(.timepicki-input)');var index_of_timepicki_input=all_form_elements.index(ele);var previous_form_element=all_form_elements.get(index_of_timepicki_input-1);previous_form_element.focus()}};first_input.on('keydown',first_input_exit_handler)}
